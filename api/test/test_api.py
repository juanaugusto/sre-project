...
class TestApi(unittest.TestCase):
    ...
    def test_it_gives_404_in_route_that_does_not_exists(cls):
        response = cls.api_app.get('/anything')
        cls.assertEqual(response.status_code, 404)

    def test_what_users_with_most_followers(cls):
    ...
    def test_total_tweets_per_hour(cls):
    ...
    def test_total_tweets_per_hashtag_and_language_location_for_user_with_one_tweet(cls):
    ...
    def test_total_tweets_per_hashtag_and_language_location_for_user_with_many_tweets(cls):
    ...
    def test_total_tweets_per_hashtag_and_language_location_for_non_existent_user(cls):
